 ...
 */
export function sanitizeString(value, maxLength = MAX_LOG_LENGTH) {
 ...
 */
export function sanitizeDomainForLog(domain) {
 ...
 */
export function sanitizeObject(obj, depth = 0, maxDepth = 3) {
