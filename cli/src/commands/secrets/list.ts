...
export default class SecretsList extends BaseCommand {
  ...
  async run(): Promise<void> {
    ...
    this.log(chalk.yellow('⚠ Listing secrets is not supported by the system keychain API'));
    this.log();
    ...
    this.log();
    this.log(chalk.gray(`Use "mcp secrets get <key>" to retrieve a specific secret`));
